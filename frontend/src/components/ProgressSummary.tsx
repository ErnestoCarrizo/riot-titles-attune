...
type Props = { progress: number; branchCount: number; challengeCount: number; playerName: string };

export function ProgressSummary({ progress, branchCount, challengeCount, playerName }: Props) {
  return (
    <section className="summary-card" aria-labelledby="summary-title">
      ...
      <div className="summary-card__copy">
        <h2 id="summary-title">Vas por buen camino, {playerName}.</h2>
